<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="create_fr1admin.aspx.cs" Inherits="school_book_fr1.create_fr1admin" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td style="text-align: center">
                        <asp:Label ID="Label15" runat="server" Font-Names="Brush Script MT" style="font-size: 30pt" Text="Create Admin Account"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td class="auto-style2">
                                    <asp:Label ID="Label33" runat="server" CssClass="auto-style4" Text="Gender"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="auto-style6">
                                    <asp:Label ID="Label31" runat="server" CssClass="auto-style4" Text="Designation"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td class="auto-style2">
                                    <asp:Label ID="Label32" runat="server" CssClass="auto-style4" Text="Securiry Level"></asp:Label>
                                </td>
                                <td>
                                        ...
                                        <table class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="TextBox13" ControlToCompare="TextBox12" ErrorMessage="Not Match"></asp:CompareValidator>
